...
public class TileManager : MonoBehaviour {
    ...
    {
        entity.Tile.BoardEntity = null;
        entity.Tile = GetTile(p);
        entity.Tile.BoardEntity = entity;
        entity.transform.position = entity.Tile.transform.position;
    }
    ...
    {
        generator.init();
        GenerateBoardResponse response = generator.generateTiles();
        this.coordinateToTile = response.coordinateToTile;
        this.tupleToWall = response.tuppleToWall;

        //this should be removed later
        AddBoardEntity(new Position(0,0), Instantiate(testBoardEntity));
    ...
    public bool AddBoardEntity(Position position, GameObject boardEntity)
    {
        ...
        {
            boardEntity.GetComponent<BoardEntity>().Tile = tile;
